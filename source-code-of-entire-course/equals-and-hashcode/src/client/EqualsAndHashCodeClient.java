...
public class EqualsAndHashCodeClient {
	public static void main(String[] args) {
		...
		Guide guidecompare=student.getGuide();
		em1.getTransaction().commit();
		em1.close();
		EntityManager em2 = emf.createEntityManager();
		em2.getTransaction().begin();
		guidecompare.setSalary(10000);
		Guide guide = em2.merge(guidecompare);
		Set<Student> students = guide.getStudents();
		System.out.println(students.contains(student));
		System.out.println(guidecompare.equals(guide));
		System.out.println(guidecompare.toString());
